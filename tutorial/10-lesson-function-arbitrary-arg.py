...
#more for file manipulation later in tutorial
with open("file.txt", "w") as myfile:
	write_multiple_items(myfile,"/",'1','2','3','4','5')

#Typical the *args is placed at the end of arguments,
#but is possible to be placed in the beginning, see the following example

def join_str (*args, sep="/"):
	return sep.join(args)

print(join_str('1','2','3'))
#Another call with different separator
